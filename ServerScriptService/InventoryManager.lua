...
UseItemRemote.OnServerEvent:Connect(function(player, itemName)
	...
	if itemCount > 0 then
		...
		local isStandItem = (itemName == "Stand Arrow" or itemName == "Saint's Corpse Part" or itemName == "Stand Disc" or itemName == "Requiem Arrow" or itemName == "Dio's Diary" or itemName == "Saint's Left Arm" or itemName == "Saint's Right Eye" or itemName == "Saint's Pelvis" or itemName == "Saint's Heart" or itemName == "Saint's Spine" or itemName == "Strange Arrow" or itemName == "Green Baby" or itemName == "Rokakaka" or itemName == "Rokakaka Branch" or itemName == "Chiikawa Mascot" or (string.find(itemName, "Disc") and itemName ~= "Memory Disc" and itemName ~= "Heavenly Stand Disc"))
		local isStyleItem = (itemName == "Memory Disc" or itemName == "Boxing Manual" or itemName == "Vampire Mask" or itemName == "Hamon Manual" or itemName == "Cyborg Blueprints" or itemName == "Ancient Mask" or itemName == "Steel Ball" or itemName == "Perfect Aja Mask" or itemName == "Golden Spin Scroll" or itemName == "Rokakaka Fruit" or itemName == "Limitless Manual" or itemName == "Cursed Finger")
		...
		elseif itemName == "VIP" or itemName == "VIP Pass" then
			if player:GetAttribute("IsVIP") then 
				message = "You are already a VIP!"; itemConsumed = false
			else 
				player:SetAttribute("IsVIP", true); message = "Unlocked VIP Status! Enjoy 2x Training Speed and your exclusive Storage Slots!" 
			end
		...
		elseif itemName == "Limitless Manual" then
			player:SetAttribute("FightingStyle", "Limitless"); message = "You grasp the concept of infinity. Gained Limitless Style!"
		elseif itemName == "Cursed Finger" then
			player:SetAttribute("FightingStyle", "Shrine"); message = "You swallow the cursed finger... Gained Shrine Style!"
		elseif itemName == "Chiikawa Mascot" then
			player:SetAttribute("Stand", "Chiikawa"); player:SetAttribute("StandTrait", "None"); message = "A small, cute creature appears beside you! Awakened Chiikawa!"
